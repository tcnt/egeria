...
public enum OMRSAuditingComponent implements ComponentDescription
{
    ...
    OPERATIONAL_SERVICES (3,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/operational-services.md"),

    ARCHIVE_MANAGER (4,
             "Archive Manager",
             "Manages the loading of Open Metadata Archives into an open metadata repository.",
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/archive-manager.md"),
    ...
    ENTERPRISE_CONNECTOR_MANAGER (5,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/enterprise-connector-manager.md"),
    ...
    ENTERPRISE_REPOSITORY_CONNECTOR (6,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/enterprise-repository-connector.md"),
    ...
    LOCAL_REPOSITORY_CONNECTOR (7,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/local-repository-connector.md"),
    ...
    REPOSITORY_CONTENT_MANAGER(8,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/typedef-manager.md"),
    ...
    INSTANCE_EVENT_PROCESSOR (9,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/local-repository-instance-event-processor.md"),
    ...
    REPOSITORY_EVENT_MANAGER (10,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/event-manager.md"),

    REST_SERVICES (11,
             "Repository REST Services",
             "Provides the server-side support the the OMRS Repository Services REST API.",
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/omrs-rest-services.md"),
    ...
    METADATA_HIGHWAY_MANAGER (13,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/metadata-highway-manager.md"),

    COHORT_MANAGER  (14,
             "Cohort Manager",
             "Manages the initialization and shutdown of the server's connectivity to a cohort.",
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/cohort-manager.md"),

    COHORT_REGISTRY(15,
             "Cohort Registry",
             "Manages the registration requests send and received from this local repository.",
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/cohort-registry.md"),
    ...
    EVENT_PUBLISHER (17,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/event-publisher.md"),

    EVENT_LISTENER  (18,
             "Event Listener",
             "Manages the receipt of incoming OMRS events.",
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/event-listener.md"),
    ...
    OMRS_TOPIC_CONNECTOR(19,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/connectors/omrs-topic-connector.md"),
    ...
    LOCAL_REPOSITORY_EVENT_MAPPER(21,
             ...
             "https://github.com/tcnt/egeria/tree/master/open-metadata-implementation/repository-services/docs/component-descriptions/connectors/event-mapper-connector.md"),
