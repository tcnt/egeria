...
As an example, the [IBM InfoSphere Information Governance Catalog Repository Connector](https://github.com/tcnt/egeria-connector-ibm-information-server)
...
[IBM InfoSphere Information Governance Catalog Repository Connector's distribution module](https://github.com/tcnt/egeria-connector-ibm-information-server/tree/master/distribution).
