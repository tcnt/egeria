...
```
An example of a use of this configuration can be found in the virtual data connector helm charts. See [odpi-egeria-vdc helm chart](https://github.com/tcnt/egeria-samples/tree/master/helm-charts/odpi-egeria-vdc/README.md)
